...
import './about.css'
import AboutImg from '../../assets/AShramko2.jpg'
import CV from '../../assets/AShramko.pdf'
import Info from './info'

const About = () => {
    return (
        <section className='about ssection' id='about'>
            <h2 className='section__title'>About Me</h2>
            <span className='section__subtitle'>My introduction</span>

            <div className='about__container container grid'>
                <img src={AboutImg} alt='foto' className='about__img' />
